      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem>
              <div className="space-y-1">
                <p className="text-sm font-medium">Grade released</p>
                <p className="text-xs text-muted-foreground">Database Systems - Assignment 2</p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <div className="space-y-1">
                <p className="text-sm font-medium">Course announcement</p>
                <p className="text-xs text-muted-foreground">Computer Networks - Class cancelled</p>
              </div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
